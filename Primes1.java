...
public class Primes1{
  ...
  public static void main (String[] args){
    ...
    while ( count < n){ //When i is a prime number according to method isPrime1, count increases by 1. 
      if (isPrime1(i)== true){
        count++;
      }
  ...
  public static boolean isPrime1(int i){
    if (i==1){
      ...
      for (int j=2; j<i;j++){ // check the remainder of i/j for every j until j=i.
        if (i%j==0){
